...
# Heres what I tried doing. I went off of your history idea but instead of coords I got history
# of pixmaps so I create a save point when the mouse is clicked and whenever ctrl+z is pressed I pop it and update the pixmap
